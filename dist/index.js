...
function check(packageJsonPath, nodeVersionPath) {
    return __awaiter(this, void 0, void 0, function* () {
        const packageJsonObj = JSON.parse((0, fs_1.readFileSync)(packageJsonPath, "utf8"));
        const voltaNodeVersion = packageJsonObj.volta.node;
        (0, core_1.debug)(`volta_node_version: ${voltaNodeVersion}`);
        const nodeVersionVersion = (0, fs_1.readFileSync)(nodeVersionPath, "utf8").replace(/\r?\n/g, "");
        (0, core_1.debug)(`node_version_version: ${nodeVersionVersion}`);
        if (voltaNodeVersion !== nodeVersionVersion) {
            throw new Error(`volta node version ${voltaNodeVersion} does not match .node_version version ${nodeVersionVersion}`);
        }
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const nodeVersionPath = (0, core_1.getInput)("node_version_path");
            (0, check_1.check)(packageJsonPath, nodeVersionPath).then((version) => {
                (0, core_1.setOutput)("version", version);
            });
            (0, core_1.info)("volta node version matches .node_version version");
        }
        catch (error) {
